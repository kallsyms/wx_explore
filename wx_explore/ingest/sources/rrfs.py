...
class RRFS(IngestSource):
    ...
    def generate_derived(grib):
        ...
        speed_sf = SourceField.query.filter(
            SourceField.source.has(Source.short_name == RRFS.SOURCE_NAME),
    ...
    def queue(
        ...
        base_url = run_time.strftime("https://noaa-rrfs-pds.s3.amazonaws.com/rrfs_a/rrfs_a.%Y%m%d/%H/rrfs.t%Hz.natlev.f{}.conus_3km.grib2")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Ingest RRFS')
