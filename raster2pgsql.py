...
# Modified from PostGIS's raster2pgsql.py
...
# UTILITIES
SUMMARY = []
LOGGER = logging.getLogger('raster2pgsql')
...
def make_options(srid, band, out_db=False):
    class Options(object):
        pass

    opt = Options()
    opt.version = g_rt_version
    opt.endian = g_rt_endian
    opt.srid = srid
    opt.band = band
    opt.register = out_db
